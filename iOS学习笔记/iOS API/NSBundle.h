...
//app的mainbundle，bundle其实理解为一个app的所有资源的集合，是很好理解的
...
//获取某种类型的文件（资源）NSString *path = [[NSBundle mainBundle] pathForResource:@"data" ofType:@"plist"];NSArray *arr = [NSArray arrayWithContentsOfFile:path];
