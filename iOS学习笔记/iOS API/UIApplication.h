...
typedef NS_ENUM(NSInteger, UIStatusBarAnimation) {
    ...
    UIStatusBarAnimationFade NS_ENUM_AVAILABLE_IOS(3_2),//淡出
    UIStatusBarAnimationSlide NS_ENUM_AVAILABLE_IOS(3_2),//向上滑出
} __TVOS_PROHIBITED;
...
typedef NS_ENUM(NSInteger, UIInterfaceOrientation) {
    ...
    UIInterfaceOrientationLandscapeLeft      = UIDeviceOrientationLandscapeRight, //为毛，这两个会相等，感觉应该相等，但说不出来
...
//设置屏幕支持的方向，NS_OPTIONS，掩码方式
typedef NS_OPTIONS(NSUInteger, UIInterfaceOrientationMask) {
    UIInterfaceOrientationMaskPortrait = (1 << UIInterfaceOrientationPortrait), //1
    UIInterfaceOrientationMaskLandscapeLeft = (1 << UIInterfaceOrientationLandscapeLeft),//2
    UIInterfaceOrientationMaskLandscapeRight = (1 << UIInterfaceOrientationLandscapeRight),//16
    UIInterfaceOrientationMaskPortraitUpsideDown = (1 << UIInterfaceOrientationPortraitUpsideDown),//4
    UIInterfaceOrientationMaskLandscape = (UIInterfaceOrientationMaskLandscapeLeft | UIInterfaceOrientationMaskLandscapeRight),//24
    UIInterfaceOrientationMaskAll = (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskLandscapeLeft | UIInterfaceOrientationMaskLandscapeRight | UIInterfaceOrientationMaskPortraitUpsideDown),//30
    UIInterfaceOrientationMaskAllButUpsideDown = (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskLandscapeLeft | UIInterfaceOrientationMaskLandscapeRight),//26
} __TVOS_PROHIBITED;
...
- (UIInterfaceOrientationMask)application:(UIApplication *)application 
                                         :(nullable UIWindow *)window  NS_AVAILABLE_IOS(6_0) __TVOS_PROHIBITED;
...
//这些过时的api，都放在了UIViewController里面，进行了更新
