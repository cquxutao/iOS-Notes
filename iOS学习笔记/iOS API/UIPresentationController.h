...
//
//http://www.jianshu.com/p/a7335474651c
...
@property(nonatomic, strong, readonly) UIViewController *presentingViewController;//跳转前的原控制器
@property(nonatomic, strong, readonly) UIViewController *presentedViewController;//将要跳转到的目标控制器
