...
typedef NS_OPTIONS(NSUInteger, UICollectionViewScrollPosition) {
    ...
    // 水平和垂直只能各选一个方向，但两者之间可以结合
    UICollectionViewScrollPositionTop                  = 1 << 0,
    UICollectionViewScrollPositionCenteredVertically   = 1 << 1,
    UICollectionViewScrollPositionBottom               = 1 << 2,
    
    // Likewise, the horizontal positions are mutually exclusive to each other.(互相排斥，只能选择一种滚动方式)
...
//
// (when the touch lifts)//手指举起，离开
// 3. -collectionView:shouldSelectItemAtIndexPath: or -collectionView:shouldDeselectItemAtIndexPath:
// 4. -collectionView:didSelectItemAtIndexPath: or -collectionView:didDeselectItemAtIndexPath:
// 5. -collectionView:didUnhighlightItemAtIndexPath://这个的执行顺序，貌似和上面描述的不一致
/*选中流程2017-09-27 11:11:26.265418+0800 CollViewSmpl[55498:7944906] collectionView:shouldHighlightItemAtIndexPath:
 2017-09-27 11:11:26.265565+0800 CollViewSmpl[55498:7944906] collectionView:didHighlightItemAtIndexPath:
 2017-09-27 11:11:26.265711+0800 CollViewSmpl[55498:7944906] collectionView:didUnhighlightItemAtIndexPath:
 2017-09-27 11:11:26.265781+0800 CollViewSmpl[55498:7944906] collectionView:shouldSelectItemAtIndexPath:
 2017-09-27 11:11:26.265891+0800 CollViewSmpl[55498:7944906] collectionView:didSelectItemAtIndexPath:
 */
/*取消选中流程2017-09-27 11:12:19.794162+0800 CollViewSmpl[55498:7944906] collectionView:shouldHighlightItemAtIndexPath:
 2017-09-27 11:12:19.794299+0800 CollViewSmpl[55498:7944906] collectionView:didHighlightItemAtIndexPath:
 2017-09-27 11:12:19.794426+0800 CollViewSmpl[55498:7944906] collectionView:didUnhighlightItemAtIndexPath:
 2017-09-27 11:12:19.794503+0800 CollViewSmpl[55498:7944906] collectionView:shouldDeselectItemAtIndexPath:
 2017-09-27 11:12:19.794633+0800 CollViewSmpl[55498:7944906] collectionView:didDeselectItemAtIndexPath:
 */
- (BOOL)collectionView:(UICollectionView *)collectionView shouldHighlightItemAtIndexPath:(NSIndexPath *)indexPath;//高亮相关，Managing Cell Highlighting
- (void)collectionView:(UICollectionView *)collectionView didHighlightItemAtIndexPath:(NSIndexPath *)indexPath;
- (void)collectionView:(UICollectionView *)collectionView didUnhighlightItemAtIndexPath:(NSIndexPath *)indexPath;
//Managing the Selected Cells
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath;//是否可选，default YES
- (BOOL)collectionView:(UICollectionView *)collectionView shouldDeselectItemAtIndexPath:(NSIndexPath *)indexPath; // called when the user taps on an already-selected item in multi-select mode//多选情况下，在已经选择的cell上点击，看是否能取消选中，default YES
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath;//已经选中
- (void)collectionView:(UICollectionView *)collectionView didDeselectItemAtIndexPath:(NSIndexPath *)indexPath;//已经取消选中

//Tracking the Addition and Removal of Views
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath NS_AVAILABLE_IOS(8_0);//将要显示
- (void)collectionView:(UICollectionView *)collectionView willDisplaySupplementaryView:(UICollectionReusableView *)view forElementKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath NS_AVAILABLE_IOS(8_0);
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath;//结束显示didEndDisplayingCell,注意，这里不是【已经显示的意思】
...
//就是长按，出现复制、剪切等菜单
- (BOOL)collectionView:(UICollectionView *)collectionView shouldShowMenuForItemAtIndexPath:(NSIndexPath *)indexPath;//the default return value is NO
//针对那个菜单的sel（action），分别作适配，比如，禁止复制等
...
//根据复用identifier返回cell
- (__kindof UICollectionViewCell *)dequeueReusableCellWithReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath;

//根据复用identifier返回supplementaryview
- (__kindof UICollectionReusableView *)dequeueReusableSupplementaryViewOfKind:(NSString *)elementKind withReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath;

// These properties control whether items can be selected, and if so, whether multiple items can be simultaneously selected.
@property (nonatomic) BOOL allowsSelection; // default is YES,是否可选
@property (nonatomic) BOOL allowsMultipleSelection; // default is NO,是否可以多选

#if UIKIT_DEFINE_AS_PROPERTIES
//返回选中的items的indexpath
//因为涉及到多选，所以返回是数组，一般用法NSIndexPath *selectedIndexPath = [self.collectionView indexPathsForSelectedItems][0];
