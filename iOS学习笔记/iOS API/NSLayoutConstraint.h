...
typedef NS_ENUM(NSInteger, NSLayoutAttribute) {
    ...
    NSLayoutAttributeLastBaseline, //baseline不懂啊
...
#ifndef NSEDGEINSETS_DEFINED //一定要把C语言学好啊
typedef struct {
    CGFloat top; 
    CGFloat left; 
    CGFloat bottom;
...
/* Create constraints explicitly.  Constraints are of the form "view1.attr1 = view2.attr2 * multiplier + constant" 
 If your equation does not have a second view and attribute, use nil and NSLayoutAttributeNotAnAttribute.//由于没有参照物，所以约束添加于自身身上(有待确认)
 Use of this method is not recommended. Constraints should be created using anchor objects on views and layout guides. 妈蛋，不被推荐//anchor objects on views and layout guides
 */
