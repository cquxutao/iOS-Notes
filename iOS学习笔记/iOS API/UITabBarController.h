...
//http://www.jianshu.com/p/b3a31eed945f
NS_ASSUME_NONNULL_BEGIN//专门提供了两个宏：NS_ASSUME_NONNULL_BEGIN和NS_ASSUME_NONNULL_END。在这两个宏之间的代码，所有简单指针对象都被假定为nonnull
...
//http://blog.csdn.net/leikezhu1981/article/details/47418011
@property(nullable, nonatomic,copy) NSArray<__kindof UIViewController *> *viewControllers;////__kindof,泛型编程
...
//http://www.jianshu.com/p/7550ee0f35ce
@property(nullable, nonatomic, copy) NSArray<__kindof UIViewController *> *customizableViewControllers __TVOS_PROHIBITED; // 点击更多按钮，弹出可操作的更多VC，默认都是可以排序修改的，If non-nil, then the "More" view will include an "Edit" button that displays customization UI for the specified controllers. By default, all view controllers are customizable.
